...
\begin{frame}{Periodendauer}%in 2 spalten
\includegraphics[scale=0.2]{Bilder/Periodendauer.jpg}
\begin{itemize}
\item<2-> $\delta_n=\delta_1\cdot b^{n-1}$ mit $0\leq b<1$
\end{itemize}
\end{frame}

\begin{frame}{Amplitude}%in 2 spalten
\includegraphics[scale=0.2]{Bilder/Periodendauer.jpg}
\begin{itemize}
...
\begin{frame}{Verallgemeinerung - Nummerische Simulation}
\center
\includegraphics[scale=0.3]{Bilder/Diff'Gleichung.jpg}
\end{frame}
\subsection{Peak}
\begin{frame}
